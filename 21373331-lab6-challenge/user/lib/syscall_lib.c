...
int syscall_set_relative_path(char *path)
{
	return msyscall(SYS_set_relative_path,path);
}
int syscall_get_relative_path(char *path)
{
	return msyscall(SYS_get_relative_path,path);
}